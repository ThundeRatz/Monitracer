...
Quick overview about the necessary programs to the development

### On windows
1. node.js

     [Chocolatey ](https://chocolatey.org/install) is needed for node.js instalation: 
    * Open windows powershell as a admnistrator
    * Run the command:
...
2. Android Studio
   ...
   * In the instalation menu keep the following boxes selected:
     * Android SDK
